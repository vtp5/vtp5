...
public abstract class SpellDictionaryASpell implements SpellDictionary {
	 ...
	 * 
	 * @param phonetic
	 *            The file to use for phonetic transformation of the words list.
	 *            If <code>phonetic</code> is null, the the transformation uses
	 ...
	 * 
	 * @param phonetic
	 *            The Reader to use for phonetic transformation of the words
	 ...
	 * @param word
	 *            Suggestions for given misspelt word
	 * @param threshold
	 ...
	 *            The lower boundary of similarity to misspelt word
	 * @param matrix
	 *            Two dimensional int array used to calculate edit distance.
