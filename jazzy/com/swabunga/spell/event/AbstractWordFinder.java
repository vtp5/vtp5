...
public abstract class AbstractWordFinder implements WordFinder {
	 ...
	 * @param startIgnore
	 *            The character that should be at <code>index</code> position to
	 *            start skipping through.
	 ...
	 *            start skipping through.
	 * @param endIgnore
	 *            The character which mark the end of skipping through. If the
	 *            value of endIgnore is <code>null</code>, skipping characters
	 ...
	 *            The start position in text.
	 * @param startIgnore
	 *            The string that should be at <code>index</code> position to
	 *            start skipping through.
	 * @param endIgnore
	 *            The string which mark the end of skipping through.
	 * @return The index position pointing after the skipped characters or the
	 *         original index if the ignore condition could not be met.
	 */
